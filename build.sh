...
<head>
    ...
    <style>
        ...
        #code {
            ...
            font-family: monospace; font-size: 14px; tab-size: 4;
        }
        button { font-size: 14px; padding: 4px 16px; margin: 4px 4px 4px 0; }
        #runner {
...
<body>
    ...
    <br>
    <button onclick="runner.src='https://cdn.jsdelivr.net/gh/lua-atmos/env-js/${tier}-${VER}.html#'+btoa(code.value)">Run</button>
